# This code uses rvest to pull in the current list of CDVS workshops
...
workshop_begins <- mdy_hm(date_time_begin, tz="EST")
workshop_ends <- mdy_hm(date_time_ends, tz="EST")
workshop_duration <- (workshop_ends - workshop_begins)
workshop_duration_minutes <- as.numeric(workshop_duration)*60

# fall 2020 modification for online courses

dvs_cal_tbl<- tibble(workshop_id,date,title,presenter,workshop_duration_minutes, workshop_begins,workshop_ends,registration_link)
...
#write_tsv(dvs_cal_tbl,path="/Users/joel/Dropbox/EDC/workshops/spring_2019/spring_2019_workshops_2019_01_17.txt")
